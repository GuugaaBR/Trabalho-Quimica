...
gameContainer.innerHTML += <div class="card-container" data-card-value="${cardValues[i].name}"> <div class="card-before"></div> <div class="card-after"> <img src="${cardValues[i].sprite}" class="image"/> </div> </div> ;
}
//Grid
...
setTimeout(() => {
result.innerHTML = <h2>Você Venceu!</h2> <h4>Moves: ${movesCount}</h4>;
stopGame();
...
result.innerHTML = <h2>Você Venceu!</h2> <h6>Moves: ${movesCount}</h6> <h4>Tempo: ${minutesValue}:${secondsValue}</h4>;
